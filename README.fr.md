...
- Dès qu'un entraînement d'ASI tourne, le système lui-même entre en jeu (clin d'œil à Person of Interest) : il surveille tous les campus rivaux, retourne périodiquement des agents ennemis proches, et porte une frappe zero-day par entraînement ; deux entraînements simultanés déclenchent un duel de dieux.
