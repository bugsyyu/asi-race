...
- Once an ASI training run goes live the system itself joins the fight (Person-of-Interest style): it surveils every rival campus for its lab, periodically turns nearby enemy operatives, and carries one zero-day strike per run; two live runs enter a god-duel.
