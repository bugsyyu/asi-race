...
const TABS = {
  ...
  '经济': () => `
    ...
    <b>☁ 云服务</b>：像巨头入局云市场那样开放算力租赁 —— 自家算力 −20%，换取数据与影响力现金流（<b>按你在地图上真实存活的机房数计费</b>：烧掉对手的数据中心就是烧掉他的云生意），还会压低全行业<b>硬件指数</b>（数据中心更便宜）。
    加密牛市、矿难、产能吃紧、开源冲击、监管风暴等<b>行业事件</b>会随时扫过市场。</p>
    <p><b>明星大牛</b>：每家实验室开局签下两位传奇研究员，各带被动加成。风险太高、信任太低会逼走他们 ——
    退圈警世、跳槽对手，或者<b>自立门户创办新势力</b>。创业公司会在中环出现，先派单位过去侦察，<b>签约收购必须有己方单位在园区完成尽调</b>（拿走范式加成和创始人）；
